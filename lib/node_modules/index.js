...
function recreate() {
    ...
    var isValueEqual = require('@timelaps/is/value-equal');
    ...
    var to = require('to');
    var is = require('@timelaps/is');
    var URL = require('URL');
    var JSON = require('@timelaps/JSON');
    ...
    return extend([{
            ...
            discard: require('object/discard'),
            ...
            returns: require('@timelaps/returns'),
            ...
            // baseDataTypes: require('@timelaps/is/base-data-types'),
            constants: require('@timelaps/constants'),
